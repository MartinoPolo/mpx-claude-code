...
# Usage: bash $HOME/.claude/skills/mp-script-discovery/scripts/detect-project-scripts.sh [project_dir] [--recursive] [--category <name>] [--json]
...
usage() {
  echo "Usage: bash $HOME/.claude/skills/mp-script-discovery/scripts/detect-project-scripts.sh [project_dir] [--recursive] [--category <name>] [--json]"
