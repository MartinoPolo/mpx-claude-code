---
name: mpx-init-repo
description: Initialize git repository with comprehensive .gitignore, push to GitHub, and set up branch protection. Use when starting a new project.
...
4. **Ask repo visibility**: Use `AskUserQuestion` to ask the user whether the GitHub repo should be **private** (default/recommended) or **public**.
