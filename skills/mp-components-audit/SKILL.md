...
description: 'Audits the codebase for design-system component usage, flagging native elements, wrong variants, and hardcoded colors that bypass theme tokens. Use when: "audit component usage", "design system audit"'
