...
```bash
cat ${CLAUDE_PLUGIN_ROOT}/../gh/skills/mp-execute/tests.md    # good vs bad tests (mp-gh plugin)
cat ${CLAUDE_PLUGIN_ROOT}/../gh/skills/mp-execute/mocking.md  # when to mock (mp-gh plugin)
